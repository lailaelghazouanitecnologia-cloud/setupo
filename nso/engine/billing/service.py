...
DEFAULT_PLANS = [
    {
        "code": "free",
        "name": "Free",
        "description": "Get started — unlimited BYOV servers, 1 GB storage, community support.",
        "interval": "monthly",
        "amount_cents": 0,
        "trial_days": 0,
        "features": {
    ...
    },
    {
        "code": "hobby",
        "name": "Hobby",
        "description": "For side projects — 1 managed instance, 5 GB storage, email support.",
        "interval": "monthly",
        "amount_cents": 700,
        "trial_days": 14,
        "features": {
    ...
    },
    {
        "code": "pro",
        "name": "Pro",
        "description": "For production — 3 managed instances, 25 GB storage, priority support.",
        "interval": "monthly",
        "amount_cents": 1900,
        "trial_days": 14,
        "features": {
