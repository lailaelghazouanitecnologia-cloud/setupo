...
logger = logging.getLogger("z86-agent.auth")

ADMIN_EMAIL = os.environ.get("NSO_ADMIN_EMAIL", "admin@nso.dev")
ADMIN_PASSWORD_HASH = os.environ.get("Z86_AGENT_PASSWORD_HASH", "")
ADMIN_PASSWORD_PLAIN = os.environ.get("Z86_AGENT_PASSWORD", os.environ.get("AGENT_ADMIN_PASSWORD", ""))

JWT_SECRET = os.environ.get("Z86_JWT_SECRET", os.environ.get("NSO_JWT_SECRET", secrets.token_hex(32)))
