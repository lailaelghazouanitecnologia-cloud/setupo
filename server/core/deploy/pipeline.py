...
from server.core.models import InstanceState, DeployState
from server.core.instances.provisioner import run_ssh_command
from server.core.deploy.sync import sync_workspace
from server.core.workspace_config import read_config
...
async def deploy_to_instance(
    ...
    try:
        ...
        if domain:
            ...
            from server.core.instances.provisioner import setup_ssl
